...
/*
Package ocp_template_api is a reverse proxy.
...
// RegisterOcpTemplateApiServiceHandlerServer registers the http handlers for service OcpTemplateApiService to "mux".
// UnaryRPC     :call OcpTemplateApiServiceServer directly.
...
// RegisterOcpTemplateApiServiceHandlerFromEndpoint is same as RegisterOcpTemplateApiServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterOcpTemplateApiServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterOcpTemplateApiServiceHandler(ctx, mux, conn)
}

// RegisterOcpTemplateApiServiceHandler registers the http handlers for service OcpTemplateApiService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterOcpTemplateApiServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterOcpTemplateApiServiceHandlerClient(ctx, mux, NewOcpTemplateApiServiceClient(conn))
}

// RegisterOcpTemplateApiServiceHandlerClient registers the http handlers for service OcpTemplateApiService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "OcpTemplateApiServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "OcpTemplateApiServiceClient"
