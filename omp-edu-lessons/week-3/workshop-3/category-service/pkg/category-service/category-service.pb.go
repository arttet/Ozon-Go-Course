...
var file_api_category_service_category_service_proto_goTypes = []interface{}{
	(*Category)(nil),                // 0: ozonmp.week_3_workshop.category_service.category_service.v1.Category
	(*GetCategoryByIdRequest)(nil),  // 1: ozonmp.week_3_workshop.category_service.category_service.v1.GetCategoryByIdRequest
	(*GetCategoryByIdResponse)(nil), // 2: ozonmp.week_3_workshop.category_service.category_service.v1.GetCategoryByIdResponse
}
var file_api_category_service_category_service_proto_depIdxs = []int32{
	0, // 0: ozonmp.week_3_workshop.category_service.category_service.v1.GetCategoryByIdResponse.category:type_name -> ozonmp.week_3_workshop.category_service.category_service.v1.Category
	1, // 1: ozonmp.week_3_workshop.category_service.category_service.v1.CategoryService.GetCategoryById:input_type -> ozonmp.week_3_workshop.category_service.category_service.v1.GetCategoryByIdRequest
	2, // 2: ozonmp.week_3_workshop.category_service.category_service.v1.CategoryService.GetCategoryById:output_type -> ozonmp.week_3_workshop.category_service.category_service.v1.GetCategoryByIdResponse
